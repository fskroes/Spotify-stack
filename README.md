...
[![Decisions](https://img.shields.io/badge/21_Decisions-11181d?style=for-the-badge)](docs/adr)
...
| Every runner↔operator wire shape is declared once, read tolerantly. | [ADR-0001](docs/adr/0001-tolerant-reader-wire-contract.md) |
| `fleet cosign` has no `--force`. A refusal is the gate working. | [ADR-0005](docs/adr/0005-operator-drives-the-cli-over-ssh.md) |

<div align="center">

<sub><b>A new agent capability is a cage change, not a feature.</b> &nbsp;·&nbsp; <a href="docs/adr">All 21 decisions →</a></sub>
