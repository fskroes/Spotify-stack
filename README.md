...
[![Decisions](https://img.shields.io/badge/30_Decisions-11181d?style=for-the-badge)](docs/adr)
...
```console
$ pnpm fleet report
Last 30 days: 40 shipped · 5 killed before review (5 verify failures, 0 scope violations).
...
<sub><b>A new agent capability is a cage change, not a feature.</b> &nbsp;·&nbsp; <a href="docs/adr">All 30 decisions →</a></sub>
