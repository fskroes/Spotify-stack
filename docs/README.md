...
| [`judge-cage-spec.md`](judge-cage-spec.md) | **Historical.** The build handoff for [ADR-0011](adr/0011-the-runner-owns-the-judges-reads.md) — the read module's shape, the two transports' flags, and how an unavailable read tool is detected. The judge it specifies was deleted on 2026-08-06 (ADR-0025); this stays because 0011 cites it. |
