...
| [0005](0005-operator-drives-the-cli-over-ssh.md) | The desktop operator drives the existing CLI over SSH — transport superseded by [0026](0026-the-desktop-operator-is-deleted.md); its co-sign gate stands | operator |
