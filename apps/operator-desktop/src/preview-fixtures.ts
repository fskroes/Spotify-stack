...
export function previewLedgerEntries(now: number): LedgerEntry[] {
  return [
    { ts: new Date(now - 12 * 60_000).toISOString(), runId: "approved", task: "004-upstream-failure-mode-tests", repo: "demo-feed-service", status: "approved", mode: "cloud", vetoes: 0, verifyState: "passed", title: "Cover upstream failure modes", elapsedMs: 186_421, prUrl: "https://github.com/example/repo/pull/42", sha: "8df31c2", evidence: ["Scope contract passed for 4 changed files", "VERIFY PASSED", "npm run test passed (42 tests)", "Judge approved with no violations"] },
    { ts: new Date(now - 9 * 60_000).toISOString(), runId: "cloud-syncing", task: "004-upstream-failure-mode-tests", repo: "demo-feed-service", status: "approved", mode: "cloud", vetoes: 0, verifyState: "passed", title: "Guard empty upstream payloads", elapsedMs: 158_004, prUrl: "https://github.com/example/repo/pull/50", sha: "a10f4c9", evidence: ["Scope contract passed for 3 changed files", "VERIFY PASSED", "Judge approved with no violations"] },
    { ts: new Date(now - 33 * 60_000).toISOString(), runId: "cloud-gone", task: "002-dedupe-feed-items", repo: "demo-feed-service", status: "approved", mode: "cloud", vetoes: 0, verifyState: "passed", title: "Dedupe feed items on ingest", elapsedMs: 201_887, prUrl: "https://github.com/example/repo/pull/51", sha: "c74be02", evidence: ["Scope contract passed", "VERIFY PASSED", "Judge approved with no violations"] },
    { ts: new Date(now - 51 * 60_000).toISOString(), runId: "cloud-retry", task: "003-add-agent-badge", repo: "demo-ts-service", status: "approved", mode: "cloud", vetoes: 0, verifyState: "passed", title: "Add agent badge", elapsedMs: 96_512, prUrl: "https://github.com/example/repo/pull/52", sha: "e0b91d4", evidence: ["Scope contract passed", "VERIFY PASSED", "Judge approved with no violations"] },
    ...
    { ts: new Date(now - 3 * 3_600_000).toISOString(), runId: "rejected", task: "004-upstream-failure-mode-tests", repo: "demo-feed-service", status: "approved", mode: "local", vetoes: 0, verifyState: "passed", title: "Cover upstream failure modes", elapsedMs: 156_733, prUrl: "https://github.com/example/repo/pull/40", sha: "b7e22d1", evidence: ["Scope contract passed", "VERIFY PASSED", "Judge approved with no violations"] },
    ...
    { ts: new Date(now - 6 * 3_600_000).toISOString(), runId: "gate-unmet", task: "002-swift-migrate-formatter", repo: "demo-swift-package", status: "approved", mode: "cloud", vetoes: 0, verifyState: "inconclusive", unmetGates: ["xcodebuild-test"], title: "Migrate the formatter helper", elapsedMs: 88_140, prUrl: "https://github.com/example/repo/pull/46", sha: "d41f8a3", evidence: ["Scope contract passed", "⚠ scope · judge green — verify INCONCLUSIVE (mandated gate never ran: xcodebuild-test)", "Judge approved with no violations"] },
